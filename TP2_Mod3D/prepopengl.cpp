...
//cette fonction permet, à partir du type récupéré lors de l'instanciation
//de déterminer comment sera dessinée la surface
...
//récupère le tableau de floats en sortie de discrétisation et l'intègre dans un VBO
...
//récupère le point S(t,s) et l'intègre dans un VBO
...
//permet de dessiner les objets voulus à partir d'un VBO
